...
static class UEnum* EBlueprintAsyncResultSwitch_StaticEnum()
{
	extern ADVANCEDSESSIONS_API class UPackage* Z_Construct_UPackage__Script_AdvancedSessions();
	static class UEnum* Singleton = NULL;
	if (!Singleton)
...
static struct FScriptStruct_AdvancedSessions_StaticRegisterNativesFBPUserOnlineAccount
{
	...
	IMPLEMENT_CLASS(UAdvancedExternalUILibrary, 662434777);
	...
	IMPLEMENT_CLASS(UAdvancedFriendsInterface, 1279421408);
	...
	IMPLEMENT_CLASS(UAdvancedFriendsGameInstance, 2801122541);
	...
	IMPLEMENT_CLASS(UAdvancedFriendsLibrary, 1874760671);
	...
	IMPLEMENT_CLASS(UAdvancedIdentityLibrary, 3964990856);
	void UAdvancedSessionsLibrary::StaticRegisterNativesUAdvancedSessionsLibrary()
	{
		...
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSessionsLibrary::StaticClass(), "EqualEqual_UNetIDUnetID",(Native)&UAdvancedSessionsLibrary::execEqualEqual_UNetIDUnetID);
		...
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSessionsLibrary::StaticClass(), "IsValidUniqueNetID",(Native)&UAdvancedSessionsLibrary::execIsValidUniqueNetID);
	...
	IMPLEMENT_CLASS(UAdvancedSessionsLibrary, 1778313538);
	...
	IMPLEMENT_CLASS(UEndSessionCallbackProxy, 1360797215);
	...
	IMPLEMENT_CLASS(UFindSessionsCallbackProxyAdvanced, 1642576625);
	...
	IMPLEMENT_CLASS(UGetUserPrivilegeCallbackProxy, 667119634);
...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_AdvancedSessions_EOnlineComparisonOpRedux()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EOnlineComparisonOpRedux::Equals")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EOnlineComparisonOpRedux::NotEquals")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EOnlineComparisonOpRedux::GreaterThan")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EOnlineComparisonOpRedux::GreaterThanEquals")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EOnlineComparisonOpRedux::LessThan")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EOnlineComparisonOpRedux::LessThanEquals")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EOnlineComparisonOpRedux::EOnlineComparisonOpRedux_MAX")), 6));
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EOnlineComparisonOpRedux_CRC() { return 1934349329U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_EBPOnlineSessionState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::NoSession")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::Creating")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::Pending")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::Starting")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::InProgress")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::Ending")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::Ended")), 6));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::Destroying")), 7));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlineSessionState::EBPOnlineSessionState_MAX")), 8));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EBPOnlineSessionState_CRC() { return 2057672382U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_EBPOnlinePresenceState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlinePresenceState::Online")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlinePresenceState::Offline")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlinePresenceState::Away")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlinePresenceState::ExtendedAway")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlinePresenceState::DoNotDisturb")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlinePresenceState::Chat")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPOnlinePresenceState::EBPOnlinePresenceState_MAX")), 6));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EBPOnlinePresenceState_CRC() { return 4138869850U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_EBPServerPresenceSearchType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPServerPresenceSearchType::AllServers")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPServerPresenceSearchType::ClientServersOnly")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPServerPresenceSearchType::DedicatedServersOnly")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPServerPresenceSearchType::EBPServerPresenceSearchType_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EBPServerPresenceSearchType_CRC() { return 304129082U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_EBlueprintAsyncResultSwitch()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBlueprintAsyncResultSwitch::OnSuccess")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBlueprintAsyncResultSwitch::AsyncLoading")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBlueprintAsyncResultSwitch::OnFailure")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBlueprintAsyncResultSwitch::EBlueprintAsyncResultSwitch_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EBlueprintAsyncResultSwitch_CRC() { return 2971600663U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_EBlueprintResultSwitch()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBlueprintResultSwitch::OnSuccess")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBlueprintResultSwitch::OnFailure")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBlueprintResultSwitch::EBlueprintResultSwitch_MAX")), 2));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EBlueprintResultSwitch_CRC() { return 1321409102U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_ESessionSettingSearchResult()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESessionSettingSearchResult::Found")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESessionSettingSearchResult::NotFound")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESessionSettingSearchResult::WrongType")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESessionSettingSearchResult::ESessionSettingSearchResult_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_ESessionSettingSearchResult_CRC() { return 4150243448U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_EBPLoginStatus()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPLoginStatus::NotLoggedIn")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPLoginStatus::UsingLocalProfile")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPLoginStatus::LoggedIn")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPLoginStatus::EBPLoginStatus_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EBPLoginStatus_CRC() { return 3145063752U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_EBPUserPrivileges()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPUserPrivileges::CanPlay")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPUserPrivileges::CanPlayOnline")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPUserPrivileges::CanCommunicateOnline")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPUserPrivileges::CanUseUserGeneratedContent")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBPUserPrivileges::EBPUserPrivileges_MAX")), 4));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EBPUserPrivileges_CRC() { return 2101186218U; }
	...
	UFunction* Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginStatusChanged()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_NewStatus = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("NewStatus"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(NewStatus, AdvancedFriendsInterface_eventOnPlayerLoginStatusChanged_Parms), 0x0010000000000180, Z_Construct_UEnum_AdvancedSessions_EBPLoginStatus());
	...
	UClass* Z_Construct_UClass_UAdvancedFriendsInterface()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginStatusChanged(), "OnPlayerLoginStatusChanged"); // 3958940925
	...
	UFunction* Z_Construct_UFunction_UAdvancedFriendsGameInstance_OnPlayerLoginStatusChanged()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_NewStatus = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("NewStatus"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(NewStatus, AdvancedFriendsGameInstance_eventOnPlayerLoginStatusChanged_Parms), 0x0010000000000180, Z_Construct_UEnum_AdvancedSessions_EBPLoginStatus());
			UProperty* NewProp_NewStatus_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_NewStatus, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedFriendsGameInstance_OnPlayerLoginStatusChanged(), "OnPlayerLoginStatusChanged"); // 595446300
